...
function MobileNavigation() {
  return (
    <Popover>
      ...
      >
        <MobileNavLink href="#features">Les Soins</MobileNavLink>
        <MobileNavLink href="#testimonials">Temoignages</MobileNavLink>
        ...
        <nav className="relative z-50 flex justify-between">
          <div className="flex items-center md:gap-x-12">
            ...
            <div className="hidden md:flex md:gap-x-6">
              <NavLink href="#features">Les Soins</NavLink>
              <NavLink href="#testimonials">Temoignages</NavLink>
